...
articleView.handleAuthorFilter = function () {
  ...
  $('#author-filter').on('change', function () { // event delegation
    ...
    if ($(this).val()) {
      ...
      //hide template
      $('article').show();
      $('.template').toggleClass('displayNoTemplate');
...
articleView.handleCategoryFilter = function () {
  ...
  // Be sure to reset the #author-filter while you are at it! .val('');?
  $('#category-filter').on('change', function () { // event delegation
...
// TODO: Call all of the above functions, once we are sure the DOM is ready.// wrap this around all of your code.
